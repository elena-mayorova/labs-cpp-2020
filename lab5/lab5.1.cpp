/*  Дан одномерный динамический массив. Удалить из него все элементы, значение которых кратно трем.
    При удалении некоторого элемента все элементы правее сдвигать на одну позицию влево.
*/
//
