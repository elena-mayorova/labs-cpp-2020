/*  Списки
    1) Реализовать абстрактный тип данных: линейный однонаправленный список объектов класса Товары
	(поля название, цена, качество) с функциями, позволяющими:
	  a) Создать список товаров
	  б) Распечатать список
	  в) Удалять элемент из головы и из хвоста списка (две функции)
	  г) Выводить инфо о товарах, стоимость которых выше средней
